    ...
    <main className="relative">
      <div className="relative z-10 mx-auto max-w-screen-sm px-4 sm:px-0">
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          ...
          <div>↳ Grew up in <span className="inline-flex items-center align-middle gap-1"><Logo src="/bc flag.png" alt="BC" /><Label>Vancouver</Label></span>, but also live in <span className="inline-flex items-center align-middle gap-1"><Logo src="/ontario flag.png" alt="Ontario" /><Label>Waterloo</Label></span>, <span className="inline-flex items-center align-middle gap-1"><Logo src="/ontario flag.png" alt="Ontario" /><Label>Toronto</Label></span>, and <span className="inline-flex items-center align-middle gap-1"><Logo src="/cali flag.png" alt="California" /><Label>San Francisco</Label></span>.</div>
          ...
          <div className="ml-4">↳ Performed at: The <span className="inline-flex items-center align-middle gap-1"><Logo src="/vancouver_civic_theatres_logo.jpeg" alt="VCT" /><Label><a href="https://vancouvercivictheatres.com/venues/orpheum/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Vancouver Orpheum</a></Label></span>, the <span className="inline-flex items-center align-middle gap-1"><Logo src="/ubc-logo-edited.jpg" alt="UBC" /><Label><a href="https://www.ubc.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">University of British Columbia</a></Label></span>, <span className="inline-flex items-center align-middle gap-1"><Logo src="/capU.jpg" alt="CapU" /><Label><a href="https://www.capilanou.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Capilano University</a></Label></span> and various churches around Vancouver.</div>
          <div>↳ My favorite hobby is 📷 <a href="/photography" className="text-green-700 hover:text-green-900 hover-underline-nudge">photography</a> and my favorite sport is <span className="inline-flex items-center align-middle gap-1"><Logo src="/badminton.png" alt="Badminton" /><Label>badminton.</Label></span></div>
        </div>
