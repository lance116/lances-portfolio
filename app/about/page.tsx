    ...
    <main className="relative">
      <div className="relative z-10 mx-auto max-w-screen-sm px-4 sm:px-0">
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          ...
          <div>↳ 📷 <a href="/photography" className="text-green-700 hover:text-green-900 hover-underline-nudge">photography</a> and my favorite sport is <span className="inline-flex items-center align-middle gap-1"><Logo src="/badminton.png" alt="Badminton" /><Label>badminton.</Label></span></div>
        </div>
