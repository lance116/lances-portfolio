    ...
    <main className="relative">
      <div className="relative z-10 mx-auto max-w-screen-sm px-4 sm:px-0">
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          ...
          <div>↳ The <span className="font-semibold">fastest</span> in <span className="inline-flex items-center align-middle gap-1"><Logo src="/waterloo-logo.png" alt="UWaterloo" /><Label><a href="https://uwaterloo.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">UWaterloo</a></Label></span>'s <span className="font-semibold">entire history</span> to get flown out to San Francisco to raise venture.</div>
          <div className="ml-4">↳ Built Cursor for mortgage brokers, received offers at a <span className="font-semibold">$7M</span> valuation, and turned them all down to build <span className="inline-flex items-center align-middle gap-1"><Logo src="/stealthlogo.jpg" alt="Stealth" className="rounded-full" /><Label>Clice</Label></span>.</div>
          <div>↳ Received full-time interest for: <span className="font-semibold">$300K</span> founding engineer role and another at <span className="inline-flex items-center align-middle gap-1"><Logo src="/icon.jpg" alt="Icon" /><Label><a href="https://icon.com/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Icon</a></Label></span>, but decided to stay in school while building <span className="inline-flex items-center align-middle gap-1"><Logo src="/stealthlogo.jpg" alt="Stealth" className="rounded-full" /><Label>Clice</Label></span>.</div>
          <div>↳ Did 3 <span className="font-semibold">highschool</span> software engineering internships.</div>
          <div>↳ <span className="font-semibold">Lead</span> Software engineer at <span className="inline-flex items-center align-middle gap-1"><Logo src="/waterloo-logo.png" alt="UWaterloo" /><Label><a href="https://uwaterloo.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">UWaterloo</a></Label></span>'s AI organization, <span className="inline-flex items-center align-middle gap-1"><Logo src="/wat.jpeg" alt="wat.ai" /><Label><a href="https://watai.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">wat.ai</a></Label></span>.</div>
          <div>↳ Programming since <span className="font-semibold">age 5</span>, entrepreneur since <span className="font-semibold">age 11</span>.</div>
          <div className="leading-[1.4]">↳ Mentored by some <span className="font-semibold">amazing</span> people. Including founders from <span className="inline-flex items-center align-middle gap-1"><Logo src="/YClogo.png" alt="YC" /><Label><a href="https://www.ycombinator.com/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Y Combinator</a></Label></span>, <span className="inline-flex items-center align-middle gap-1"><Logo src="/speedrun.jpg" alt="speedrun" /><Label><a href="https://speedrun.a16z.com/" target="_blank" rel="noreferrer" className="hover-underline-nudge">speedrun</a></Label></span>, <span className="inline-flex items-center align-middle gap-1"><Logo src="/zfellows.jpg" alt="Z Fellows" /><Label><a href="https://www.zfellows.com/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Z Fellows</a></Label></span> and <span className="inline-flex items-center align-middle gap-1"><Logo src="/thielfellow.png" alt="Thiel Fellows" /><Label><a href="https://thielfellowship.org/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Thiel Fellowship</a></Label></span>.</div>
          <div>↳ <span className="font-semibold">2100+</span> followers on <span className="inline-flex items-center align-middle gap-1"><Logo src="/linkedin.webp" alt="LinkedIn" /><Label><a href="https://www.linkedin.com/in/lance-yan/" target="_blank" rel="noreferrer" className="hover-underline-nudge">LinkedIn</a></Label></span>, <span className="font-semibold">1300+</span> followers on <span className="inline-flex items-center align-middle gap-1"><span className="relative -top-[1px]"><Logo src="/X.png" alt="X" /></span></span>, with posts totaling <span className="font-semibold">1M+</span> views.</div>
        </div>
