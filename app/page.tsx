    ...
    <main className="relative">
      <div className="relative z-10 mx-auto max-w-screen-sm px-4 sm:px-0">
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          ...
          <div>↳ <span className="font-bold slight-italic">3200+</span> followers on <span className="inline-flex items-center align-middle gap-1"><Logo src="/linkedin.webp" alt="LinkedIn" /><Label><a href="https://www.linkedin.com/in/lance-yan/" target="_blank" rel="noreferrer" className="hover-underline-nudge">LinkedIn</a></Label></span>, <span className="font-bold slight-italic">1500+</span> followers on <span className="inline-flex items-center align-middle gap-1"><span className="relative -top-[1px]"><Logo src="/X.png" alt="X" /></span></span>, with posts totaling <span className="font-bold slight-italic">1.6M+</span> views.</div>
        </div>
