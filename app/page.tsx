    ...
    <main className="relative">
      <div className="relative z-10 mx-auto max-w-screen-sm px-4 sm:px-0">
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          ...
          <div>↳ <span className="inline-flex items-center align-middle gap-1"><Logo src="/ratemycompany logo.png" alt="ratemycompany.ca" /><Label><a href="https://www.ratemycompany.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">ratemycompany.ca</a></Label></span>. Got <span className="font-bold slight-italic">20K+</span> users and <span className="font-bold slight-italic">2M+</span> votes within <span className="font-bold slight-italic">24h</span>.</div>
