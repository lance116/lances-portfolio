    ...
    <main className="relative">
      <div className="relative z-10 mx-auto max-w-screen-sm px-4 sm:px-0">
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          ...
          <div>↳ Built <span className="inline-flex items-center align-middle gap-1"><Logo src="/ratemycompany logo.png" alt="ratemycompany.ca" /><Label><a href="https://www.ratemycompany.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">ratemycompany.ca</a></Label></span>, got <span className="font-bold slight-italic">40K+</span> users and <span className="font-bold slight-italic">2.5M+</span> votes within <span className="font-bold slight-italic">48 hours</span>.</div>
          <div className="ml-4">↳ Implemented measures to prevent thousands of bots trying to get their favorite company to the top (<span className="font-bold slight-italic">4 million</span> edge requests in <span className="font-bold slight-italic">12 hours</span>).</div>
