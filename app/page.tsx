    ...
    <main className="relative">
      <div className="relative z-10 mx-auto max-w-screen-sm px-4 sm:px-0">
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          ...
          <div>↳ Built <span className="inline-flex items-center align-middle gap-1"><Logo src="/ratemycompany logo.png" alt="ratemycompany.ca" /><Label><a href="https://www.ratemycompany.ca/" target="_blank" rel="noreferrer" className="hover-underline-nudge">ratemycompany.ca</a></Label></span>, got <span className="font-bold slight-italic">20K+</span> users and <span className="font-bold slight-italic">2M+</span> votes within <span className="font-bold slight-italic">24h</span>.</div>
          ...
          <div className="ml-4">↳ Turned down <span className="font-bold slight-italic">$7M</span> valuation offers to build <span className="inline-flex items-center align-middle gap-1"><Logo src="/clice white logo.png" alt="Clice AI" className="border border-neutral-300 dark:border-neutral-600 rounded" /><Label>Clice AI</Label></span> heads-down in Waterloo.</div>
          <div>↳ Received full-time interest for: <span className="font-bold slight-italic">$300K</span> founding engineer role and another at <span className="inline-flex items-center align-middle gap-1"><Logo src="/icon.jpg" alt="Icon" /><Label><a href="https://icon.com/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Icon</a></Label></span>, but decided to go all in on building <span className="inline-flex items-center align-middle gap-1"><Logo src="/clice white logo.png" alt="Clice AI" className="border border-neutral-300 dark:border-neutral-600 rounded" /><Label>Clice AI</Label></span>.</div>
          ...
          <div>↳ Prev Growth at <span className="inline-flex items-center align-middle gap-1"><Logo src="/symbal_logo.jpeg" alt="Symbal" /><Label><a href="https://www.symbal.ai/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Symbal</a></Label></span>, backed by Peter Thiel and <span className="inline-flex items-center align-middle gap-1"><Logo src="/founders fund.jpeg" alt="Founders Fund" /><Label><a href="https://foundersfund.com/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Founders Fund</a></Label></span>.</div>
          <div>↳ Prev Fellow at <span className="inline-flex items-center align-middle gap-1"><Logo src="/boardy_logo.jpeg" alt="Boardy" /><Label><a href="https://www.boardy.ai/" target="_blank" rel="noreferrer" className="hover-underline-nudge">Boardy</a></Label></span>, Fall 2025 Cohort.</div>
        ...
        <div className="text-sm sm:text-[0.95rem] leading-tight space-y-2">
          <div>◆ Building:</div>
          <div>↳ <span className="inline-flex items-center align-middle gap-1"><Logo src="/clice white logo.png" alt="Clice AI" className="border border-neutral-300 dark:border-neutral-600 rounded" /><Label>Clice AI</Label></span>. AI agents for the lending industry.</div>
